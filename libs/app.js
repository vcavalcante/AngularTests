var enderecoController = function($scope){
    ...
    $scope.endereco.tipoLogradouro = [{nome:'Rua',id:1},{nome:'Osasco',estado:'SP'},{nome:'Avenida',id:3}]      ;
    $scope.enderecos =[];
    $scope.enderecos.push({estado:{nome:'São Paulo',id:'SP'},cidade:'Riosdafasd',cep:'3243242',tipoLogradouro:'rua',logradouro:'adsfdasfd dafs fdsa dfs'});
